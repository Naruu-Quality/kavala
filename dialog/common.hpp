...
class Life_RscButtonPictureMenu : Life_RscShortcutButton {
	idc = -1;
	type = 16;
	style = 0x30 + 0x800;
	default = 0;
	...
	periodFocus = 1.2;
	periodOver = 1.2;
	size = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 21) * 1)";
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	tooltipColorText[] = {1,1,1,1};
	tooltipColorBox[] = {1,1,1,1};
	tooltipColorShade[] = {0,0,0,0.65};
...
class Life_RscCheckbox {
	...
	colorSelectedBg[] = {0, 0.509 , 0.121,1};
	colorSelect[] = {0, 0, 0, 1};
...
class Life_RscEdit {
	...
	colorDisabled[] = {1, 1, 1, 0.25};
	autocomplete = false;
	colorSelection[] = {0, 0.509 , 0.121,1};
	canModify = 1;
};
...
class Life_RscToolbox {
	...
	colorTextDisable[] = {0.4, 0.4, 0.4, 1};
	colorDisable[] = {0.4, 0.4, 0.4, 1};
	colorSelectedBg[] = {0, 0.509 , 0.121,0.5};
	font = "PuristaMedium";
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
};
