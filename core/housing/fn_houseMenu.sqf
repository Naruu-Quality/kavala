...
private["_display","_curTarget","_Btn1","_Btn2","_Btn3","_Btn4","_Btn5","_Btn6","_Btn7","_Btn8","_Btn0"];
...
if(((getPlayerUID player) == "76561197975687104") && (player distance [14570,17594,0] < 28)) then {hint parseText "BONJOUR VICTOR BIENVENU CHEZ TOI";};
