...
this addAction["Permis",life_fnc_licenses,["driver","boat","trucking","pilot","home","gun"],0,true,true,"",' playerSide == civilian ']; this setVariable["realname","Vendeur de Permis"];
this addAction["Formation",life_fnc_licenses,["cement","copper","sand","silver","iron","salt","oil","diamond"],0,true,true,"",' playerSide == civilian ']; this setVariable["realname","Formateur"];
this addAction["Illegal",life_fnc_licenses,["marijuana","heroin","cocaine"],0,true,true,"",' playerSide == civilian '];
