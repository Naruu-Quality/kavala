...
*/
private["_item_list","_gear_list","_shopItems","_name","_price","_sellPrice"];
...
if(!isClass(missionConfigFile >> "VirtualShops" >> life_shop_type)) exitWith {closeDialog 0; hint parseText "Config does not exist?";}; //Make sure the entry exists..
...

{
	...
	if((_val > 0) && (!(EQUAL(_sellPrice,-1)))) then {
