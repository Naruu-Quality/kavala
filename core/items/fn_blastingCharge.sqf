...
if({_x getVariable ["rank",0] > 0} count playableUnits < (LIFE_SETTINGS(getNumber,"cops_online_min"))) exitWith {
...
[[0,7],"STR_ISTR_Blast_Placed"] remoteExecCall ["life_fnc_broadcast",west];
