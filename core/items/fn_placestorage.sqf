...
if (life_activeObj == ObjNull) exitWith {};
...
if ((typeOf _container) == "Land_Sink_F") then {
    [false,"illegalbox",1] call life_fnc_handleInv;
};
if ((typeOf _container) == "CargoNet_01_barrels_F") then {
    [false,"illegalboxbig",1] call life_fnc_handleInv;
};
if ((typeOf _container) == "Land_OfficeCabinet_01_F") then {
    [false,"armoire",1] call life_fnc_handleInv;
};
if ((typeOf _container) == "Fridge_01_closed_F") then {
