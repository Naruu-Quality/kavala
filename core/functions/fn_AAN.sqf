...
_anonyme = _this select 4;

_timer cutRsc ["rscAAN","plain"];
_display = uiNamespace getVariable "BIS_AAN";
_textHeader = _display displayCtrl 3001;
if(_anonyme)then
{
	_textHeader ctrlSetStructuredText parseText format [localize "STR_News_BroadcastedBy",_header,"Anonyme"];
}else
{
...
_textLine ctrlSetStructuredText parseText format["                         %1                         %1                         %1                         %1                         %1                         %1                         %1                         %1",_line];
