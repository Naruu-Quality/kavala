...
_return = [];
_savedVirtualItems = ["pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "atele", "adnpack", "transpack", "cartevisa", "menotte", "blastingcharge", "boltcutter", "defuseKit","storageSmall","storageBig","illegalbox","armoire","frigo","illegalboxbig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","truckWheel"];
