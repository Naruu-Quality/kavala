...
if (_status == 3) exitWith {hint parseText "You cannot retrieve an item that is in your inventory already!";};
...
if (count _found == 0) exitWith {hint parseText "This item has been sold recently";};
