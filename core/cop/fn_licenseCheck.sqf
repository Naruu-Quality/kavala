...
*/
private["_cop","_licenses","_licensesConfigs","_namePlayer"];
...
if(license_civ_identite)then
{
	_namePlayer = profileName;
}else
{
	_namePlayer = "Pas de carte";
};

[_namePlayer,_licenses] remoteExecCall ["life_fnc_licensesRead",_cop];